...
## .yellow[Sesión 9: Texto simple y Rmarkdown]
...
## 3. Documentos dinámicos y RMarkdown
...
.center[
![:scale 70%](../../files/img/slides/W_workflow.png)
]

---
# Abriendo el archivo de escritura tradicional

![](../../files/img/slides/realWord.png)
...
.center[
![](../../files/img/slides/bowers&healey.png)]
...
![](../../files/img/slides/marcas-edi.png)
---
...
![](../../files/img/slides/markdownpreview.png)
]
...
![:scale 90%](../../files/img/slides/pandoc.png)
...
## 3. .yellow[Documentos dinámicos y RMarkdown]
...
.pull-right[
.center[
![:scale 60%](../../files/img/slides/copypaste.png)
]
]
...
.center[
![:scale 70%](../../files/img/slides/rmarkdown.gif)
]
---
# Iniciar documento RMarkdown en RStudio
...
.pull-left[
<br>
![:scale 100%](../../files/img/slides/YAML.png)
]
...
- Menú en ventana de RStudio *Insert* > R ![:scale 20%](../../files/img/slidesinsertchunk.png)
...
<br>
<br>
![:scale 80%](../../files/img/slides/knitmenu.png)
]
]
...
![:scale 80%](../../files/img/slides/render.png)
